...
public class MunitBehavior implements ContainerBehavior {
    ...
    private boolean isMockOrSpyElement(Element element) {
        return MunitPlugin.MOCK_NAMESPACE.equals(element.getNamespace()) && ("when".equals(element.getName()) || "throw-an".equals(element.getName()) ||"spy".equals(element.getName()) || "outbound-endpoint".equals(element.getName()));
    }

...
public class MunitPlugin extends AbstractUIPlugin {
	...
	public static final ImageDescriptor RUN_ICON_DESCRIPTOR = AbstractUIPlugin.imageDescriptorFromPlugin(DebugUIPlugin.getUniqueIdentifier(), ICONS_PATH
			+ "/full/etool16/run_exc.gif");
	public static final ImageDescriptor DEBUG_ICON_DESCRIPTOR = AbstractUIPlugin.imageDescriptorFromPlugin(DebugUIPlugin.getUniqueIdentifier(), ICONS_PATH
			+ "/full/eview16/debug_persp.gif");

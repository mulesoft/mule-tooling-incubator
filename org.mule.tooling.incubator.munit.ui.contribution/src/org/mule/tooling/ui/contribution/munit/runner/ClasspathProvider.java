...
/**
 * <p>
 * Class path provider for the Munit Launch configuration
 * </p>
 */
public class ClasspathProvider {
    ...
    protected void addClassPath(final IJavaProject javaProject, Collection<URL> urls) throws JavaModelException, MalformedURLException { /*
                                                                                                                                          * This path includes the name of the
                                                                                                                                          * project. The files it is being used to
                                                                                                                                          * attach to already have that, so we
                                                                                                                                          * remove it in the variable.
                                                                                                                                          */

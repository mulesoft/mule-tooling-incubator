...
package org.mule.tooling.properties.model;
...
public class CommentedProperties extends java.util.Properties {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8787113112410043895L;
	...
	public void store(OutputStream out, String header) throws IOException {
		// The spec says that the file must be encoded using ISO-8859-1.
		Writer outputStreamWriter = new OutputStreamWriter(out, "ISO-8859-1");
		store(outputStreamWriter, header);
	}

	public void store(Writer outputStreamWriter, String header) {
	 ...
	 * @return
	 */
	public Object put(Object keyString, Object value) {
	...
	public synchronized Object remove(Object key) {
		int indexOf = keyData.indexOf(key);
		lineData.remove(indexOf);
		keyData.remove(indexOf);

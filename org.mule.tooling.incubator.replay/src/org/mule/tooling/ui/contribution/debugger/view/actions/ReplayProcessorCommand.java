...
public class ReplayProcessorCommand extends Command {

    private MessageSnapshot snapshot;

    protected ReplayProcessorCommand(MessageSnapshot snapshot) {
        super();
    ...
    public void execute() {
        ...
        if (activeEditor instanceof MultiPageMessageFlowEditor) {
            ...
            MuleDebuggerService.getDefault().getDebuggerClient().replayMessageProcessor(snapshot, appName, mpPath);
        }
    }

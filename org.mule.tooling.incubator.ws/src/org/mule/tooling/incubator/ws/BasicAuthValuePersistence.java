...
public final class BasicAuthValuePersistence implements INestedElementChooser, IValueConverter
{

    private static final String checkbox = "enableBasicAuth";
    private static final String watermarkId = "@http://www.mulesoft.org/schema/mule/ws2/basic-auth";

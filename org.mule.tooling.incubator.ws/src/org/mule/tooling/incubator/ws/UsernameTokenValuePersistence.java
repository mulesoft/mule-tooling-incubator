...
public final class UsernameTokenValuePersistence implements INestedElementChooser, IValueConverter
{

    private static final String checkbox = "enableUsernameToken";
    private static final String watermarkId = "@http://www.mulesoft.org/schema/mule/ws2/wss-username-token";

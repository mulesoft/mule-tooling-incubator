...
public class CreateDomainBuildGradleWizardPageExtension extends CreateBuildGradleWizardPageExtension {
	public CreateDomainBuildGradleWizardPageExtension() {
		super(GradleMulePlugin.STUDIO_DOMAIN);
	}

...
@SupportedOptions(value = { "enabledStudioPluginPackage", "enableJavaDocValidation", "mavenInformationFile", "enabledVerboseLogging" })
public class StudioAnnotationProcessor extends AnnotationProcessor {
    ...
    private boolean needsToDisplayBuildTooltip(Set<? extends TypeElement> annotations,RoundEnvironment env) {
        //Since we are building connectors with Connection Strategies this will always return true
        return true;
    }

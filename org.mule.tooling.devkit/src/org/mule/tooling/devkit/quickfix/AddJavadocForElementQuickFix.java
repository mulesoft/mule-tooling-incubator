...
public class AddJavadocForElementQuickFix extends QuickFix {
    ...
    AddJavadocForElementQuickFix(String label, ConditionMarkerEvaluator evaluator) {
    ...
    public static TagElement getLastParamTag(Javadoc javadoc) {
        ...
        for (int i = 0; i < nTags; i++) {
            ...
            if (TagElement.TAG_PARAM.equals(currName) || TagElement.TAG_RETURN.equals(currName)) {
                retVal = curr;
            }
        }
        return retVal;

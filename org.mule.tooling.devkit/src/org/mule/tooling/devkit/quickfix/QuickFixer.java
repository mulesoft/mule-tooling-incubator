...
public class QuickFixer implements IMarkerResolutionGenerator {
    ...
    private void loadQuickFixes() {
        ...
        fixes.add(new ChangeInvalidateAnnotation("Change annotation from @InvalidateConnectionOn @ReconnectOn", new MessageEquals(Message.INVALIDATECONNECTIONON_IS_DEPRECATED)));
        ...
        fixes.add(new AddJavadocSampleReferenceQuickFix("Add sample reference", new MessageMatches(Message.METHDO_MISSING_EXAMPLE)));

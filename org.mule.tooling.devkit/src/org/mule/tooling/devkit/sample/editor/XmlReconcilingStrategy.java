...
public class XmlReconcilingStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension {
     ...
     * when this method is called, {@link #cNextPos} must point to the character after &lt;, when it returns, it points to the character after &gt; or after the range. About syntax
     * errors: this method is not a validator, it is useful. Side effect: writes number of found newLines to {@link #cNewLines}.
     *

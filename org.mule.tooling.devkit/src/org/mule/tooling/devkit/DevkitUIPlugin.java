...
import org.mule.tooling.devkit.preferences.WorkbenchPreferencePage;
...
public class DevkitUIPlugin extends AbstractUIPlugin implements IStartup {
    ...
    protected void scheduleResetPerspectiveOnUpdateJob() {
        ...
        if (currentVersion.compareTo(storedVersion) != 0) {
            AnalyticsRecordsFactory.single("DEVKIT_PLUGIN_INSTALL", "OLD_VERSION", storedVersion.toString(),"NEW_VERSION",currentVersion.toString()).track();
    ...
    public void logInfo(String message) {
        this.getLog().log(new Status(Status.INFO, PLUGIN_ID, message));
    }

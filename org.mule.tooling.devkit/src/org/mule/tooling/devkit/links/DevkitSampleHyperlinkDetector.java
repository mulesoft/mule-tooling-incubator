...
public class DevkitSampleHyperlinkDetector extends AbstractHyperlinkDetector {
    ...
    public IHyperlink[] detectHyperlinks(ITextViewer textViewer, IRegion region, boolean canShowMultipleHyperlinks) {
        ...
        IEditorInput editor = (IEditorInput) textEditor.getEditorInput();
        if (editor instanceof FileEditorInput) {
            FileEditorInput fe = (FileEditorInput) editor;
            ...
            try {
                ...
                if (matcher.find()) {
                    ...
                    if ((offset != -1) && (lastChar != -1)) {
                        ...
                        links[0] = new SampleHyperlink(reg.getOffset() + offset, (lastChar - offset) + 1, "Link to devkit Sample", "Go to sample", value.substring(
                                value.indexOf("@"), value.indexOf("}")), fe.getFile().getProject());
                        return links;
                    }
                }
